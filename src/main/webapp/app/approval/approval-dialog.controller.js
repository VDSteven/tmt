(function() {
    ...
    ApprovalDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'WorkDay', 'User', 'Project'];

    function ApprovalDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, WorkDay, User, Project) {
        var vm = this;
